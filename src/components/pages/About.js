          ...
          <div className="about-staff-grid">
            <div className="staff-item-left">
              ...
              <div className="staff-description">
                <h3>Dan Mooney</h3>
                As Principal at LZA Ann Arbor, Dan managed the day-today
                operations of the firm and served as project manager for all of
                the firm's projects, maintained client relations and headed up
                the firm's sustainable design initiatives. Prior to that, he was
                a Senior Associate at Hobbs & Black Architects for 12 years
                where he specialized in healthcare projects throughout southeast
                Michigan and the greater Lansing area. Dan has over 25 years'
                experience in the profession and is licensed in the state of
                Michigan. Current and recent clients include the Michigan League
                of Conservation Voters, Ann Arbor DDA, Journey of Faith
                Christian Church, Haggerty Dental, Republic Parking Systems,
                Branch Line School and Linear Mold and Engineering.
              </div>
            </div>
